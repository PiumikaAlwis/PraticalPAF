...
public class HospitalAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * hosObj.updateHospital(paras.get("hidIDSave").toString(),
	...
	/*
	 * private Map getParasMap(HttpServletRequest request) { // TODO Auto-generated
	 * method stub Map<String, String> map = new HashMap<String, String>(); try {
	 ...
	 * : params) { String[] p = param.split("="); map.put(p[0], p[1]); } } catch
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response, Hospital hosObj)
		...
		/*
		 * Map paras = getParasMap(request); String output =
		 * hosObj.deleteHospital(paras.get("hos_Id").toString());
		 * response.getWriter().write(output);
		 */
	}
